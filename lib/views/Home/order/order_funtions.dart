  ...
  var skipRecords = skip;
  {
    final response = await get(
      Uri.parse(
        ...
        '&\$expand=C_OrderLine(\$orderby=Created;\$expand=C_Tax_ID,M_Product_ID,C_Charge_ID),Bill_Location_ID,C_BPartner_ID,Bill_User_ID,C_POSPayment,C_DocTypeTarget_ID,C_Invoice(\$select=RelatedInvoice_ID,DocStatus)',
      ),
      headers: {
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': Token.auth!,
