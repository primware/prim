...
import 'package:primware/views/Home/bpartner/bpartner_controller.dart';
import '../../../shared/button.widget.dart';
import '../../../shared/textfield.widget.dart';
import '../../../theme/colors.dart';
import 'bpartner_funtions.dart';

class BPartnerPage extends StatefulWidget {
  final String? bpartnerName;

  const BPartnerPage({super.key, this.bpartnerName});

  @override
  State<BPartnerPage> createState() => _BPartnerPageState();
}

class _BPartnerPageState extends State<BPartnerPage> {
  bool isValid = false;
