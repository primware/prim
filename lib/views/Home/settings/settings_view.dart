...
class _SettingsPageState extends State<SettingsPage> {
  ...
  // --- Lógica del Indicador de Fuerza ---
    ...
    final bool? confirm = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Una vez actualizada tu contraseña, se cerrará la sesión actual y tendrás que ingresar nuevamente con tus nuevas credenciales.'),
          actions: [
            TextButton(
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        if (responseData['isError'] == true) {
          // Si iDempiere devuelve 200 OK pero dice isError: true
          print('====== ERROR INTERNO DEL PROCESO ======');
          print(response.body);
          ToastMessage.show(context: context, message: responseData['summary'] ?? 'Error en el proceso', type: ToastType.failure);
        } else {
          // Éxito real
          ToastMessage.show(context: context, message: 'Contraseña actualizada. Redirigiendo...', type: ToastType.success);
        ...
        ToastMessage.show(context: context, message: 'Error: ${response.statusCode}', type: ToastType.failure);
      }
    } catch (e) {
      if (!mounted) return;
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(
            text,
            style: TextStyle(color: isMet ? Colors.green.shade700 : Colors.grey.shade600, fontWeight: isMet ? FontWeight.w600 : FontWeight.normal),
          ),
        ],
      ),
    );
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (confirmPasswordController.text.isNotEmpty && !passwordsMatch)
                        Padding(
                          ...
                          child: Align(
                            ...
                            child: Text('Las contraseñas no coinciden', style: TextStyle(color: Colors.red.shade400, fontSize: 12)),
                          ),
                        ),
                      ...
                      Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text('Nivel de seguridad', style: TextStyle(fontSize: 12, color: Colors.grey.shade600)),
                              Text(
                                _strengthText,
                          ...
                          ClipRRect(
                            ...
                            child: LinearProgressIndicator(value: newPasswordController.text.isEmpty ? 0 : _passwordStrength / 3, backgroundColor: Colors.grey.shade200, color: _strengthColor, minHeight: 6),
                          ),
                        ],
                      ),
                      ...
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [_buildRequirementRow('Exactamente 8 caracteres', hasMinLength), _buildRequirementRow('Al menos una letra Mayúscula', hasUppercase), _buildRequirementRow('Al menos una letra minúscula', hasLowercase)]),
                      ),
