      ...
      build: (pw.Context context) {
        return pw.Column(
          ...
          children: [
            ...
            pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [pw.Text('Base Imp. Dev:'), pw.Text(money(returnTaxBase))]),
            pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [pw.Text('Impuesto Dev:'), pw.Text(money(returnTaxAmt))]),
            pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [pw.Text('Exento Dev:'), pw.Text(money(returnExemptAmt))]),
